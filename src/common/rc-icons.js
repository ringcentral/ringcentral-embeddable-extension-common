...
export const meetingIconSvg = (size = 18) => {
  return `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}"><path fill="#0684BD" fill-rule="nonzero" d="M4 5.333h13.849a4 4 0 014 4v13.333a4 4 0 01-4 4H4a4 4 0 01-4-4V9.333a4 4 0 014-4zm19.978 7.278l6.034-3.397a1.333 1.333 0 011.987 1.162v11.248a1.333 1.333 0 01-1.987 1.162l-6.034-3.397a1.332 1.332 0 01-.679-1.162v-4.455c0-.482.26-.926.679-1.162z"></path></svg>`
}
